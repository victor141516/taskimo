...
const onSave = () => {
  newItem.value = new ProjectItem(newItem.value.name, newItem.value.description, newItem.value.dueDate)
...
<template>
  <form class="px-5" @submit="onSave">
    <ItemForm v-model:item-data="newItem" :auto-focus-name="true"></ItemForm>
    <div class="flex justify-center">
      <button class="btn btn-primary btn-sm mt-4" type="submit" :disabled="newItem.name === ''">Save</button>
    </div>
  </form>
</template>