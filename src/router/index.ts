...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/projects/:projectId/item/:itemId', component: ProjectItemComponent },
    { path: '/projects/:projectId/item/:itemId/new-item', component: NewProjectItem },
    { path: '/projects/:projectId/item/:itemId/item/:itemPath(.+)', component: ProjectItemComponent },
    { path: '/projects/:projectId/item/:itemId/item/:itemPath(.+)/new-item', component: NewProjectItem },
  ]
})
