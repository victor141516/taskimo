...
export enum ProjectItemStatus { Pending, Done }
...
export class ProjectItem {
  ...
  constructor(name: string, description: string, dueDate: DateTime | null | undefined = null, status: ProjectItemStatus = ProjectItemStatus.Pending, items: Array<ProjectItem> = []) {
